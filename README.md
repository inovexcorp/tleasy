...
```
cd existing_repo
git remote add origin https://gitlab.inovexcorp.com/tleasy/tleasy.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.inovexcorp.com/tleasy/tleasy/-/settings/integrations)
